      ...
      if(values != null){
        values.forEach((key, values)  async {
          ...
          if(values["averageHeartRate"] !="NaN") {
            ...
            listHeartRate.add(int.parse(values["averageHeartRate"]));
          }

          dataList.add(DataModel(
              averageHeartRate: values["averageHeartRate"].toString(),
        ...
        int totalSlep = avgTotalSleepTime.inMinutes;


        deepSleepPr = (avgDeep.inMinutes/totalSlep)*100;
        lightSleepPr = (avgLight.inMinutes/totalSlep)*100;
        wakeSleepPr = (avgWake.inMinutes/totalSlep)*100;
        remSleepPr = (avgRem.inMinutes/totalSlep)*100;

        print("DEEP SLEEP PER: $deepSleepPr");
        print("DEEP Light PER: $lightSleepPr");
        print("DEEP Light PER: $wakeSleepPr");
        print("DEEP Light PER: $remSleepPr");
